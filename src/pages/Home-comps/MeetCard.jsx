...
const MeetCard = ({person}) => {
    const {image , name , specialization} = person;
    return (
        <div>
            <div className="card bg-base-100 w-full border-[1px] border-gray-400 shadow-xl">
                ...
                <div className="card-body items-center text-center">
                    ...
                    <p className="text-gray-700 text-xl">{specialization}</p>
